...
/**
 * 현재 Embedding Job Attempt 소유권으로 문서 Chunk 생성을 요청하는 DTO.
 *
 * <p>Worker ID와 canonical UUID Claim Token만 입력받으며 Token은 소유권 검증에만 사용하고
 * 응답, 이벤트와 로그에는 노출하지 않는다.
 */
public record CreateDocumentChunksRequest(
