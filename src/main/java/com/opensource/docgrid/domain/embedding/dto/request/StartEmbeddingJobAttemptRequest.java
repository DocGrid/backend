...
/**
 * 현재 Embedding Job Claim 소유권으로 실행 Attempt를 시작하기 위한 요청 DTO.
 *
 * <p>Worker ID와 canonical UUID Claim Token만 입력받으며, Token은 소유권 검증에만 사용하고 응답에는
 * 재노출하지 않는다.
 */
public record StartEmbeddingJobAttemptRequest(
